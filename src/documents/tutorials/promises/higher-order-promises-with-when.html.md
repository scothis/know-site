...
In previous tutorials we looked at [how to consume promises](./consuming-promises) and [how to create promises](./creating-promises). In this tutorial, we'll look at limitations with normal higher order functions in a promise environment, and how [when.js](https://github.com/cujojs/when) solve these issues.
